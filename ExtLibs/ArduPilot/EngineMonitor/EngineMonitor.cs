...
namespace RFD.EngineMonitor
{
    ...
    public class TVehicleStatus
    {
        ...
        void CheckPacket(MissionPlanner.MAVState MAV,
            MAVLink.MAVLINK_MSG_ID ID)
        {
            var mavLinkMessage = MAV.getPacket((uint)ID);
            if (mavLinkMessage != null)
            {
                GotMsg(mavLinkMessage, ID);
            }
        }

        public void CheckPackets(MissionPlanner.MAVState MAV)
        {
            CheckPacket(MAV, MAVLink.MAVLINK_MSG_ID.ICE_ENGINE_DATA);
            CheckPacket(MAV, MAVLink.MAVLINK_MSG_ID.ICE_ENGINE_EXH_TEMP_1);
            CheckPacket(MAV, MAVLink.MAVLINK_MSG_ID.ICE_ENGINE_EXH_TEMP_2);
            CheckPacket(MAV, MAVLink.MAVLINK_MSG_ID.ICE_ENGINE_FAULT_STATS_1);
            CheckPacket(MAV, MAVLink.MAVLINK_MSG_ID.ICE_ENGINE_FAULT_STATS_2);
            CheckPacket(MAV, MAVLink.MAVLINK_MSG_ID.ICE_ENGINE_STATUS);
        }
